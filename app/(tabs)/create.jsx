...
const Create = () => {
  ...
  // Set up video player
  const player = useVideoPlayer(form.video?.uri || '', (playerInstance) => {
    playerInstance.loop = false; // Configure player options
  });

  const openPicker = async (selectType) => {
    // It allow to choose document form our device...
    ...
    // if we canceled the operation of uploading it automatically sets the value to be null...
    if(!result.canceled) {
      if(selectType === 'image') {
